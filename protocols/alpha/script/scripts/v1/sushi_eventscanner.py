...
if __name__ == "__main__":
    ...
    RCC_ADDRESS = "0x6B3595068778DD592e39A122f4f5a5cF09C90fE2"  # sushi address
    ...
    goblins = [eth_sushi_goblin, eth_usdt_goblin, eth_usdc_goblin, eth_dai_goblin,
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "./events/sushi_events_v1.json"
    ...
    def run():
        ...
        start_block = max(state.get_last_scanned_block() -
                          chain_reorg_safety_blocks, 10736094)  # when homora bank start
        end_block = json.load(
