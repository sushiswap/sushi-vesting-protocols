...
def _fetch_events_for_all_contracts(
    ...
    # print("web3.eth", web3.eth.getLogs)
...
if __name__ == "__main__":
    ...
    eth_sushi_goblin = "0x3c2BBB353B48D54B619dB8Ac6AA642627Fb800E3"
    eth_usdt_goblin = "0xd902A3BEdEbaD8bEAD116E8596497cf7d9f45dA2"
    eth_usdc_goblin = "0xf134fDD0BBCE951e963D5BC5b0ffe445C9B6c5C6"
    eth_dai_goblin = "0xd6419FD982a7651A12a757Ca7cD96b969D180330"
    eth_wbtc_goblin = "0x54a2C35D689F4314FA70DD018eA0a84C74506925"
    eth_band_goblin = "0xA7120893283cC2Aba8155D6b9887bF228a8a86d2"
    eth_link_goblin = "0xCfbD9eEAc76798571eD96ED60cA34df35F29Ea8D"
    eth_aave_goblin = "0xBb4755673e9DF77f1Af82F448D2b09F241752c05"
    eth_comp_goblin = "0x35952c82e146dA5251F2f822D7B679f34FFA71D3"
    eth_snx_goblin = "0x8C5cecc9abd8503D167e6a7F2862874b6193e6e4"
    eth_susd_goblin = "0x69FE7813f804a11E2fd279eBA5Dc1Ecf6D6bF73B"
    eth_uma_goblin = "0x8Fc4c0566606Aa0c715989928C12cE254F8E1228"
    eth_ren_goblin = "0x37Ef9C13fAA609D5EEE21F84e4c6c7Bf62e4002e"
    eth_yam_goblin = "0x9d9C28f39696CE0Ebc42AbaBd875977060e7aFa1"
    eth_curve_goblin = "0x5c767dbF81eC894B2d70f2AA9E45A54692d0D7EB"
    eth_yfi_goblin = "0x6D0Eb60D814A21E2BEd483c71879777c9217aa28"
    eth_kp3r_goblin = "0x795D3655D0d7ecBf26dD33B1a7676017Bb0ee611"
    eth_bor_goblin = "0x6A279Df44B5717E89B51645e287C734Bd3086c1f"
    eth_obtc_goblin = "0x1001eC1B6Fc2438E8be6fFA338D3380237c0399a"

    RCC_ADDRESSES = [eth_sushi_goblin, eth_usdt_goblin, eth_usdc_goblin, eth_dai_goblin,
                     eth_wbtc_goblin, eth_band_goblin, eth_link_goblin, eth_aave_goblin, eth_comp_goblin,
                     eth_snx_goblin, eth_susd_goblin, eth_uma_goblin, eth_ren_goblin, eth_yam_goblin,
                     eth_curve_goblin, eth_yfi_goblin, eth_kp3r_goblin, eth_bor_goblin, eth_obtc_goblin]
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "./events/goblin_events.json"
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            transfer = {
                ...
                "id": args.id,
                "share": args.share,
                "goblin": event.address,
                "block_number": block_number,
                "timestamp": block_when.isoformat(),
                "block_timestamp": int(block_when.timestamp()),
            }
    ...
    def run():
        ...
        scanner = EventScanner(
            ...
            contract=ERC20,
            state=state,
            events=[ERC20.events.AddShare, ERC20.events.RemoveShare],
            filters={"address": RCC_ADDRESSES},
        ...
        start_block = max(state.get_last_scanned_block() -
                          chain_reorg_safety_blocks, 11007158)  # homora bank v1 created
        # end_block = scanner.get_suggested_scan_end_block()
        end_block = json.load(
            open('./configs/end_block.json'))
