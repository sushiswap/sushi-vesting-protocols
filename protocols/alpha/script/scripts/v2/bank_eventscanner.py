...
if __name__ == "__main__":
    ...
    # homora v2 legacy bank address
    RCC_ADDRESSES = "0x5f5Cd91070960D13ee549C9CC47e7a4Cd00457bb"
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "./events/bank_events_v2.json"
    ...
    def run():
        ...
        scanner = EventScanner(
            ...
            contract=ERC20,
            state=state,
            events=[ERC20.events.PutCollateral,
                    ERC20.events.TakeCollateral, ERC20.events.Liquidate],
        ...
        start_block = max(state.get_last_scanned_block() -
                          chain_reorg_safety_blocks, 11515006)  # when early goblin contract is deployed
        # end_block = scanner.get_suggested_scan_end_block()
        end_block = json.load(open('./configs/end_block.json'))
