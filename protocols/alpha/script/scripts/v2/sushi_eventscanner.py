...
if __name__ == "__main__":
    ...
    sushi_wrapper = "0x373ae78a14577682591E088F2E78EF1417612c68"
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "./events/sushi_events_v2.json"
    ...
    def run():
        ...
        start_block = max(state.get_last_scanned_block() -
                          chain_reorg_safety_blocks, 11515006)  # when homora bank start
        # end_block = scanner.get_sugxgested_scan_end_block()
